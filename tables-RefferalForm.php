...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="tables-RefferalForm.php" class= "active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Transfer Refferal</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Transfer Refferal</li>
          <li class="breadcrumb-item active">Refferal Form</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
