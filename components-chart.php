...
<head>
  ...
  <title>Patients Registration / Chart And kineme</title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="components-chart.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="text-align:left;">Charts</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      <div class="row">
        ...
        <title>Patient's Chart - Lying-In Birthing Delivery Form</title>
    <style>
        body {
...
<body>
    <h1>Patient's Chart - Lying-In Birthing Delivery Form</h1>
    <form method="POST" action="record-chart.php">
        <table>
            <tr>
            ...
            <tr>
                <td>
                    <strong>Name:</strong> <input type="text" name="patient_name"><br>
                    <strong>Date of Birth:</strong> <input type="text" name="date_of_birth"><br>
                    <strong>Address:</strong> <input type="text" name="address"><br>
                    <strong>Contact Number:</strong> <input type="text" name="contact_number"><br>
                </td>
                <td>
                    <strong>Date of Admission:</strong> <input type="text" name="date_of_admission"><br>
                    <strong>Expected Due Date:</strong> <input type="text" name="expected_due_date"><br>
                    <strong>Delivery Type:</strong> <input type="text" name="delivery_type"><br>
                    <strong>Delivery Date:</strong> <input type="text" name="delivery_date"><br>
                    <strong>Delivery Time:</strong> <input type="text" name="delivery_time"><br>
                    <strong>Delivery Weight:</strong> <input type="text" name="delivery_weight"><br>
                </td>
                <td>
                    <strong>Medical Conditions:</strong> <input type="text" name="medical_conditions"><br>
                    <strong>Allergies:</strong> <input type="text" name="allergies"><br>
                    <strong>Medications:</strong> <input type="text" name="medications"><br>
                    <strong>Previous Pregnancies:</strong> <input type="text" name="previous_pregnancies"><br>
                    <strong>Complications:</strong> <input type="text" name="complications"><br>
                </td>
            </tr>
        </table>
