...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="components-admission-slip.php" class="active">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 style="text-align:left;">Admission Slip</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Patients Registration</li>
          <li class="breadcrumb-item active">Admission Slip</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
<body>
    <div class="container">
        ...
        <!-- Emergency Contact and Consent Section -->
        <div class="section">
